...
The fixed-income sessions are built on **Open Source Bond Asset Pricing**
([openbondassetpricing.com](https://openbondassetpricing.com)) — corrected corporate-bond
data and open code by **Alexander Dickerson** (UNSW), **Philippe Mueller** (Warwick), and
**Cesare Robotti** (Warwick); anchor paper *Priced Risk in Corporate Bonds*, Journal of
Financial Economics (2023). Their work, their credit: every notebook that touches their
data carries a citation cell naming them. Your task in this module is **computational
reproduction** — recomputing the team's published numbers from their own processed
data. That is the first rung of replication and the way research quality control
starts; full replication rebuilds from raw inputs, and neither is the same claim as
original research.
