...
45–75 minutes when the local environment already works, or up to 120 minutes for a first setup;
use the published support/fallback route rather than absorbing an unbounded setup burden.
**Combined arrival budget:** Start Here plus academic Week 1 work totals **90–130 minutes when
the environment already works** and **up to 175 minutes for a first setup**. Stop at the published
support boundary rather than spending more.
